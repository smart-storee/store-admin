...
export const Card = ({ children, title, className = '', hover = false, onClick }: CardProps) => {
  return (
    <div
      className={`
    ...
    >
      {title && (
        <div className="px-4 py-5 sm:px-6 border-b border-[#E5E7EB] dark:border-[#334155] bg-[#F9FAFB] dark:bg-[#0f172a]">
          <h3 className="text-lg leading-6 font-semibold text-[#111827] dark:text-[#f8fafc]">
            {title}
          </h3>
        </div>
      )}
