      ...
      <div className="mx-auto" style={{ width: "375px", maxWidth: "100%" }}>
        ...
        >
          ...
          >
            ...
            <div className="flex items-center gap-1">
              <div
                ...
                style={{ backgroundColor: isDarkMode ? "#475569" : "#94a3b8" }}
              ></div>
              <div
                className="w-4 h-2 rounded-sm"
                style={{ backgroundColor: isDarkMode ? "#475569" : "#94a3b8" }}
          ...
          >
            ...
            <div
              className="px-4 pt-2 pb-3 bg-white border-b"
              style={{ borderColor: isDarkMode ? "#334155" : "#e5e7eb" }}
            >
              <div className="flex items-center justify-between mb-2">
                <div className="px-3 py-1.5 rounded-full text-xs font-semibold text-white"></div>
              ...
              <div className="flex items-center">
                <div className="flex items-center gap-1.5">
                  ...
                  <span
                    ...
                    style={{ color: isDarkMode ? "#cbd5e1" : "#374151" }}
                  >
                    Select Branch
                  </span>
            ...
            <div className="px-4 pt-4 pb-3">
              <div className="flex items-center gap-3">
                <div
                  className="flex-1 flex items-center gap-2 px-4 py-3 rounded-xl bg-white"
                                ...
                                <div className="absolute inset-0 p-5 flex items-center justify-between">
                                  <div>
                                    ...
                                    <p
                                      ...
                                      style={{ color: "#6b7280" }}
                                    >
                                      {config.banners.items.length} banner
                                      {config.banners.items.length > 1
                                        ? "s"
                                        : ""}{" "}
                                      configured
                          ...
                          <div className="px-4 pb-2">
                            {(() => {
                              ...
                              const featuredProducts = products.filter((p) =>
                                featuredIds.includes(p.product_id)
                              );
                              const displayProducts =
                                featuredProducts.length > 0
                                  ? featuredProducts.slice(
                                      0,
                                      config.products.showCount || 6
                                    )
                                  : products.slice(
                                      0,
                                      config.products.showCount || 6
                                    ...
                                    >
                                      <div className="relative h-30 bg-gray-100">
                                        ...
                                        {product.is_bestseller === 1 && (
                                          <div
                                            className="absolute top-2 left-2 px-2 py-1 rounded-lg text-white text-xs font-bold flex items-center gap-1"
                                            style={{
                                        ...
                                        {product.is_vegetarian === 1 && (
                                          <div
                                            className="absolute bottom-2 left-2 w-5 h-5 rounded-full border-2 border-white"
                                            style={{
                                              backgroundColor: "#22c55e",
                                            }}
                                          ></div>
                      ...
                      sections.push(
                        <div key="categories" className="mb-4">
                          ...
                          >
                            {categories.slice(
                              0,
                              config.categories.showCount || 8
                            ).length > 0 ? (
                              categories
                                .slice(0, config.categories.showCount || 8)
                                .map((category) => (
                                  <div
                                  ...
                                  >
                                    ...
                                    <p
                                      className="text-xs font-semibold line-clamp-2 text-center"
                                      style={{
                                        color: isDarkMode
                                          ? "#cbd5e1"
                                          : "#4b5563",
            ...
            {config.dynamicContent?.enabled &&
              config.dynamicContent.sections && (
