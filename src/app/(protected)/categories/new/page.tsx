  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (responses.every((r) => r.success)) {
        ...
        throw new Error(failedResponse?.message || "Failed to create category");
      }
    } catch (err: any) {
          ...
          >
                ...
                {branches.length > 0 ? (
                  <div className="col-span-6">
                    ...
                    <p className="text-sm text-gray-500 mb-3">
                      ...
                      in. You can select all branches or specific ones.
                    </p>
                    <div className="mb-3">
                    ...
                    {selectedBranches.length === 0 && (
                      <p className="text-sm text-yellow-600 mt-2">
                        Please select at least one branch. If none selected, the
                        first active branch will be used as default.
                      </p>
                    )}
                  </div>
                ) : (
            ...
            <div className="px-4 py-5 sm:px-6 bg-gray-50 border-t border-gray-200 flex justify-end gap-3 sticky bottom-0 z-10">
              ...
              <button
                ...
                title={
                  branches.length === 0 ? "Please create a branch first" : ""
                }
              >
